...
const platforms: PlatformConfig[] = [
  {
    ...
    label: "Bsale",
    color: "blue",
    description: "Sistema principal de inventario. Todas las sincronizaciones parten desde aquí.",
    fields: [
      { key: "accessToken", label: "Access Token", placeholder: "tu-access-token-de-bsale", type: "password" },
      { key: "officeId", label: "Office ID (opcional)", placeholder: "1 — deja vacío para todas las bodegas" },
    ],
  },
  {
    platform: "paris",
    ...
    color: "green",
    description: "Marketplace Paris de Cencosud.",
    fields: [
      { key: "apiKey", label: "API Key", placeholder: "tu-api-key-de-paris", type: "password" },
  ...
  },
  {
    ...
    label: "Falabella",
    color: "orange",
    description: "Falabella Seller Center Marketplace.",
    fields: [
      { key: "apiKey", label: "API Key", placeholder: "tu-api-key-de-falabella", type: "password" },
      { key: "sellerId", label: "Seller ID", placeholder: "tu-seller-id" },
    ],
  },
  {
    ...
    label: "Ripley (Mirakl)",
    color: "purple",
    description: "Ripley Marketplace vía plataforma Mirakl MMP.",
    fields: [
      { key: "apiKey", label: "API Key (Mirakl)", placeholder: "tu-api-key-de-mirakl", type: "password" },
    ],
  },
];
