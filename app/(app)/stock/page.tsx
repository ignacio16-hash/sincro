...
export default function StockPage() {
  ...
  return (
    <div className="p-8">
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            disabled={refreshing}
            className="px-4 py-2.5 text-sm font-medium text-white bg-indigo-600 rounded-xl hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
      ...
      {refreshMsg && (
        <div className="mb-6 px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm text-slate-700">
          {refreshMsg}
        </div>
      )}
